...
import UserContactPage from "./userControl/UserContactPage";
import ContactPageLoading from "./loadingPages/ContactPageLoading";
					...
					{!contentLoading ? (
						...
						<div className="w-full">
							<div className="flex w-full gap-2 mt-4">
								<div className="bg-gray-500 rounded-full h-8 w-1/2 animate-pulse"></div>
							</div>
							<div className="flex w-full gap-2 mt-4">
								<div className="bg-gray-500 rounded-full h-8 w-1/2 animate-pulse"></div>
							</div>
					...
					{!contentLoading ? (
						<>
							<div className="flex gap-2 items-center">
								...
								<a href={linkedIn} className="underline cursor-pointer w-full ">
									{linkedIn}
								</a>
							</div>
							<div className="mt-3 flex gap-2 items-center">
								...
								<a href={"mailto:" + mail} className="underline cursor-pointer">
									{mail}
								</a>
							</div>
							<div className="mt-3 flex gap-2 items-center">
